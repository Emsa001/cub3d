...
/*   Updated: 2024/09/06 12:43:36 by btvildia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_textures *init_textures(t_textures *t, void *mlx)
{
	...
	if (c->map->no)
		...
		wall_north->image = mlx_xpm_file_to_image(mlx, "assets/old/north.xpm", &wall_north->width, &wall_north->height);
	...
	if (c->map->so)
		...
		wall_south->image = mlx_xpm_file_to_image(mlx, "assets/old/south.xpm", &wall_south->width, &wall_south->height);
	...
	if (c->map->ea)
		...
		wall_east->image = mlx_xpm_file_to_image(mlx, "assets/old/east.xpm", &wall_east->width, &wall_east->height);
	...
	if (c->map->we)
		...
		wall_west->image = mlx_xpm_file_to_image(mlx, "assets/old/west.xpm", &wall_west->width, &wall_west->height);
