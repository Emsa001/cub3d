...
/*   Updated: 2024/07/13 18:23:35 by btvildia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_textures *init_textures(t_textures *t, void *mlx)
{
	...
	wall_north->image = mlx_xpm_file_to_image(mlx, "assets/square1.xpm", &wall_north->width, &wall_north->height);
	...
	wall_south->image = mlx_xpm_file_to_image(mlx, "assets/square2.xpm", &wall_south->width, &wall_south->height);
