...
/*   Updated: 2024/10/04 19:59:40 by escura           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	item_button(t_button *button, float size)
{
	...
	const int			item_x = button->x + \
		(button->width - item_texture.width * size * 2) / 2;
	const int			item_y = button->y + \
		(button->height - item_texture.height * size * 2.3) / 2;
