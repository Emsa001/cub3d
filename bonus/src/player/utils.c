...
/*   Updated: 2024/09/16 18:22:32 by btvildia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void lane_distance(t_draw *draw)
{
    ...
    raw_distance = distance(draw->facing_sprite_x, draw->facing_sprite_y, x2, y2);
    adjusted_distance = raw_distance * cos(player_angle - draw->angle);
    draw->facing_sprite_dist = adjusted_distance;
    draw->facing_sprite_height = (BLOCK_SIZE * HEIGHT) / adjusted_distance;
}
